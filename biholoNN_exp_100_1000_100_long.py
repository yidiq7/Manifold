...
class KahlerPotential(tf.keras.Model):
    ...
    def __init__(self):
        ...
        self.layer2 = Dense(100,1000, activation=tf.square)
        self.layer3 = Dense(1000,100, activation=tf.square)
