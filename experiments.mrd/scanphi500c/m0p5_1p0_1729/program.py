...
with open(saved_path + "summary.txt", "a") as f:
    f.write('{} {} {} {} {:.10g} {:.10g} {:.10g} {:.10g} {:.10g} {:.10g} {:.10g} {:.10g}\n'.format(model_name, loss_func.__name__, psi, phi, n_pairs, train_time, sigma_train, sigma_test, E_train, E_test, E_max_train, E_max_test))
    #f.write('%s %g %d %f %f %f %f %f %f %f\n' % (model_name, psi, n_pairs, train_time, train_loss, test_loss, E_train, E_test, E_max_train, E_max_test))

#HEADER:   model_name loss_func psi phi n_pairs train_time sigma_train sigma_test E_train E_test E_max_train E_max_test
