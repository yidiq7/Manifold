...
saved_path = 'experiments_nannu/biholo/3layers/f3/'
model_name = layers + '_f3' + '_seed' + str(seed) + '_npsi_' + str(int(10*psi)) + '_alpha_' + str(int(10*alpha))
...
if __name__ =='__main__':
    ...
    with open(saved_path + "NegativePsi_summary.txt", "a") as f:
        f.write('%d %g %d %f %f %f %f %f \n' % (seed, psi, alpha, n_pairs, train_time, train_loss, test_loss, delta_sigma_train, delta_sigma_test))
